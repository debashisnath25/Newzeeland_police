              ...
              <div class="tab-pane fade padding active in" id="home1">
				...
				<h4 class="normal">What's the one thing that would improve your productivity right now? </h4>
					...
					<div class="media">
					  <div class="media-left"><a href="javascript:void(0)" class="btn btn-default btn-circle btn-lg"><i class="fa fa-comment-o"></i></a></div>
					  <div class="media-body">
						<h4 class="normal">Screen Resolution(4 Comments)</h4>
					...
					<div class="media">
					  <div class="media-left"><a href="javascript:void(0)" class="btn btn-default btn-circle btn-lg"><i class="fa fa-comment-o"></i></a></div>
					  <div class="media-body">
						<h4 class="normal">Chat Room(4 comments)</h4>
				...
				<h4 class="normal">Accomplishment</h4>
					...
					<div class="media">
					  ...
					  <div class="media-body">
						<h4 class="normal">Projects(4 Comments)</h4>
				...
				<h4 class="normal">Autonomy</h4>
					...
					<div class="media">
					  ...
					  <div class="media-body">
						<h4 class="normal">Decisions(3 Comments)</h4>
